...
@section('hero')
    <h1>Perumahan Grand Satya</h1>
    
    <h2>Kami adalah penyedian perumahan terpercaya dan jaminan layanan perencanaan tempat yang mudah dan murah</h2>
      ...
      <section id="services">
        <div class="container wow fadeIn">
          <div class="section-header">
            ...
            <p class="section-description">Karena kami menyediakan Hunian asri,aman dan nyaman</p>
          </div>
          <div class="row">
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
              <div class="box">
                <div class="icon"><i class="fa fa-shield"></i></div>
                <h4 class="title">Keamanan perumahan</h4>
                <p class="description">menyediakan keamanan bagi penghuni perumahan</p>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
              <div class="box">
                ...
                <p class="description">bisa dicicl </p>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
              <div class="box">
                ...
                <p class="description">kenyamanan dan kepuasan penghuni menjadi tujuan kami</p>
              </div>
            </div>
          </div>
        ...
        <div class="container wow fadeIn">
          <div class="row">
            <div class="col-lg-9 text-center text-lg-left">
              <h3 class="cta-title">Bergabung dan menjadi salah satu penghuni</h3>
