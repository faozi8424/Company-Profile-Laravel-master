...
<head>
  <meta charset="utf-8">
  <title>GRAND SATYA - GRAND SATYA GROUP</title>
...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <a href="#hero">
          <img src="{{asset('user/images/foto promosi 1.jpg')}}" style="margin-right:5px" width="40px"/></img>
          <h2 class="d-inline text-light">GRAND SATYA</h2>
        </a>
      </div>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>GRAND SATYA</strong>. All Rights Reserved
      </div>
      <div class="credits">
        Designed by <a href="https://bootstrapmade.com/">GRAND SATYA</a>
      </div>
    </div>
  </footer><!-- #footer -->
